          ...
          <v-card>
              ...
              <v-card-actions>
                ...
                <v-btn
                  color="red darken-1"
                  text
                  @click="saqueDialog = false; valorDeposito = ''"
                >
                  Cancelar
                </v-btn>
                <v-btn
...
<script>
import { retirarDeposito } from '@/firebase/crud'
...
export default {
  ...
  methods: {
    ...
    async sacarDeposito() {
      this.saqueDialog = false
      await retirarDeposito(this.valorDeposito, this.currentUser.email)
      this.valorDeposito = ''
    },
